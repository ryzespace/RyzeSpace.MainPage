    ...
    <>
      <section className="relative z-10 py-16 md:py-20 lg:py-28">
        <div className="container">
          <SectionTitle
            title="Ekskluzywna prezentacja naszej platformy"
            paragraph="Zobacz, jak rewolucjonizujemy branżę serwerową. Ta prezentacja zmieni Twoje podejście do infrastruktury IT."
            center
            mb="80px"
          />
        </div>
