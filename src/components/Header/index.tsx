                    ...
                    {menuData.map((menuItem, index) => (
                      <li key={index} className="group relative">
                        {menuItem.path ? (
                          ...
                          <span className="flex cursor-pointer py-2 text-base text-dark hover:text-primary dark:text-white/70 dark:hover:text-white lg:mr-0 lg:inline-flex lg:px-0 lg:py-6">
                            {menuItem.title}
                          </span>
                        )}
                      </li>
